...
$(document).ready(function(){
    ...
    if(phone==""){
        ...
        $("#error4").html("enter a valid number")
        numberChecking = false
    }
...
$(document).ready(function(){
    ...
    if(message.length<20){
        $("#error5").html("enter minimum 20 charaters")
...
$(document).ready(function(){
    ...
    $("#contact-form").submit((e)=>{
        ...
        if(nameChecking&&lastChecking&&emailChecking&&numberChecking&&messageChecking){
        $.ajax({
